...
export const start = action({
  ...
  handler: async (ctx, args) => {
    ...
    await ctx.runMutation(internal.integrations.beginPinterest, {
      workspaceId: args.workspaceId,
...
export const completeOAuth = internalAction({
  ...
  handler: async (ctx, args): Promise<string> => {
    const oauthState = await ctx.runMutation(internal.integrations.consumePinterestState, {
    ...
    await ctx.runMutation(internal.integrations.finishPinterest, {
      workspaceId: oauthState.workspaceId,
